...
const en: Messages = {
  ...
  home: {
    titleBefore: "Seal today’s words",
    titleAfter: "until that day",
    lead: "Write a message, set the unlock time, then promise it for USD $2.00. The words stay hidden until then.",
  ...
  create: {
    ...
    lead: "Enter an email, a message, and an unlock time, then promise it for USD $2.00. Sealed cards show only the unlock time.",
    email: "Email",
    emailHelp: "Where the unlock notice will be sent.",
    emailPlaceholder: "you@example.com",
    body: "Message",
    bodyPlaceholder: "Write the words you want your future self to read.",
    ...
    submit: "Promise for USD $2.00",
    demoNote: "Virtual payment — you will not be charged. Live mode sends you to Stripe Checkout for $2.00.",
    liveNote: "Stripe Checkout charges USD $2.00 to seal. Cancel or failure leaves it unsealed.",
    sealingDemo: "Promising…",
    sealingLive: "Going to checkout…",
    sealedEyebrow: "Promised",
    sealedUntil: "promised until",
    sealedHidden: "The message is hidden on this screen until it opens.",
    ...
    retry: "Promise the same draft for USD $2.00",
  },
  errors: {
  ...
  success: {
    ...
    title: "Promised",
    body: "The letter stays hidden until it opens. An unlock notice will arrive by email.",
    until: "promised until",
    list: "View list",
  },
  open: {
    lockedEyebrow: "Promised",
    lockedTitle: "Not yet",
    lockedBody: "The letter stays hidden until the promised time.",
    until: "Opens",
  ...
  email: {
    subject: "Your promise is open",
    heading: "The seal is lifted",
    intro: "The words left for this day have arrived.",
    cta: "Open the promise",
  },
};
