...
const ko = {
  ...
  home: {
    title: "오늘의 말을\n그날까지 약속하세요",
    subtitle: "메시지를 남기고 개봉 시각을 정한 뒤 USD $2.00로 약속합니다. 그 전까지 내용은 화면에 나타나지 않습니다.",
    cta: "타임캡슐 만들기",
    secondary: "어떻게 하나요",
  ...
  write: {
    title: "새 타임캡슐",
    placeholder: "미래의 나에게 남길 말을 적어 주세요.",
    hint: "이메일, 메시지, 개봉 시각을 적고 USD $2.00로 약속하세요. 약속된 카드에는 개봉 시각만 보입니다.",
    cta: "계속",
  },
  seal: {
    title: "USD $2.00로 약속하기",
    body: "Stripe Checkout으로 USD $2.00를 결제하면 약속됩니다. 실패·취소 시 봉인되지 않습니다.",
    cta: "USD $2.00로 약속하기",
    note: "가상 결제입니다. 실제 청구는 없습니다. 라이브 모드에서는 Stripe Checkout $2.00로 이동합니다.",
  },
  empty: {
    line1: "별이 빛나는 밤에",
    line2: "꿈과 사랑, 약속을 묻다",
  ...
  open_email: {
    subject: "약속이 열렸습니다",
    preheader: "정해진 날이 되었습니다.",
    body: "정해진 날에 남긴 말이 도착했습니다.",
    cta: "약속 열기",
  },
  notFound: {
...
const en: Messages = {
  ...
  home: {
    ...
    subtitle: "Write it. Seal it. Open it when the time comes.",
    cta: "Start writing",
  ...
  write: {
    ...
    hint: "A few lines is enough. You’ll seal it next.",
    cta: "Continue",
  },
  seal: {
    title: "Seal for $2",
    body: "Once sealed, it stays locked until your open date.",
    cta: "Seal · $2",
  ...
  lock: {
    title: "Locked",
    body: "This promise opens on {date}.",
  ...
  open_email: {
    ...
    preheader: "The time you chose has come.",
    body: "Hi — the promise you sealed is ready. Open it when you’re ready.",
